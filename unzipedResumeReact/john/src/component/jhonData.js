const jhonData = {
  ...
  aboutme: "About Me",
  aboutdetails:
    "I am Amanuel Deo Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever It has survived not only five centuries, but also the leap into electronic but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing",
  service: [
    {
      id: 1,
      ...
      menuItems: [
        {
          id: 1,
          icon: "icon_pin_alt",
          text: "Address: 1000 N 4th st Mr 446 fairfield IA 52556",
        },
        {
          id: 2,
          icon: "icon_phone",
          text: "Phone: +1.301.679.9991",
        },
        {
          id: 3,
          icon: "icon_mail",
          text: "Email: amecha@miu.com",
        },
        {
          id: 4,
          icon: "icon_globe",
          text: "Website: http://amanuelwebsite.com.s3-website-us-east-1.amazonaws.com/",
        },
      ],
    },
  ],
