...
class Form extends Component {
    ...
    onSubmit = () => {
        ...
        axios.post('https://4lel4bozfi.execute-api.us-east-1.amazonaws.com/v1/contact', correctData).then((response) => {
            alert("Sent")
    ...
    render() {
        return (
            <form id="contactForm">
                ...
                <textarea name="message" id="message" className="form-control" rows="6" placeholder="Your Message* ..."
                    onChange={
                        this.onChange
                }></textarea>
                {
